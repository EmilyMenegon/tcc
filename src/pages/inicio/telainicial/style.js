...
export const Circle = styled.span`
  ...
  background: #f9be06;
  opacity: 0.9;
  box-shadow: 0 0 20px rgba(249, 190, 6, 0.4);
  z-index: 1;
...
export const AboutWord = styled.span`
  ...
  padding: 8px 14px;
  border-radius: 20px;
  background: ${({ $found }) => ($found ? "#f9be06" : "#e5e5e5")};
  color: #111;
...
export const GameFeedback = styled.div`
  ...
  padding: 16px 25px;
  border-radius: 14px;
  background: ${({ $success }) => ($success ? "#f9be06" : "#111")};
  color: ${({ $success }) => ($success ? "#111" : "#fff")};
  font-size: ${({ $success }) =>
    $success ? "clamp(1rem, 2vw, 1.5rem)" : "clamp(1.5rem, 4vw, 2.8rem)"};
  font-weight: 900;
  text-align: center;
  line-height: 1.2;
...
export const FeatureCard = styled.div`
  ...
  @media (max-width: 900px) {
    ...
    &:nth-child(1), &:nth-child(2) {
      border-bottom: 1px solid #f9be06;
    }
  ...
  @media (max-width: 550px) {
    border-right: none;
    border-bottom: 1px solid #f9be06 !important;
...
export const FeatureIcon = styled.div`
  ...
  ${FeatureCard}:hover & {
    ...
    box-shadow: 0 10px 25px rgba(249, 190, 6, 0.3);
  }
`;
